...
<html lang="en" dir="ltr">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <?php else: ?>
        <li class="nav-item">
          <a class="nav-link" href="signin.php?logout=1"><i class="fa fa-sign-in" aria-hidden="true"></i></a>
        </li>
      <?php endif ?>
    </ul>
  </div>
      ...
      <div class="d-flex justify-content-center search">
        ...
        <?php
         ...
         if(isset($_POST['Search'])){ ?>
                      ...
                      <?php
                      $db = mysqli_connect('localhost','root','','registered') or die("could not connect to database");
                      ...
                      <tr>
                        ...
                        <td> <?php if(isset($_SESSION['uname'])):?>
                           <a href="thankyou.php?Book=<?php echo $row['Travel_code']; ?>&Day=<?php echo $row['Day_ID']; ?>&Time_ID=<?php echo $row['Time_ID']; ?>"
